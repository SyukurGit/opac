                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="text-right">
                            ...
                            <p class="text-xl font-bold text-slate-800" x-text="`Rp ${totalDenda.toLocaleString('id-ID')}`">
                            </p>
                        </div>
                    ...
                    <thead class="text-xs font-semibold uppercase text-slate-500 bg-slate-50">
                        <tr>
                            ...
                            <th class="p-4 whitespace-nowrap">
                                <div class="font-semibold text-left">NIM (Member ID)</div>
                            </th>
                            <th class="p-4 whitespace-nowrap">
                                <div class="font-semibold text-left">Kode Buku</div>
                            </th>
                            <th class="p-4 whitespace-nowrap">
                                <div class="font-semibold text-left">Keterlambatan</div>
                            </th>
                            <th class="p-4 whitespace-nowrap">
                                <div class="font-semibold text-left">Jumlah Denda</div>
                            </th>
                            <th class="p-4 whitespace-nowrap">
                    ...
                    <tbody class="text-sm divide-y divide-slate-100">
                        @forelse ($daftar_denda as $item)
                            <tr class="hover:bg-slate-50 transition-opacity duration-300"
                                :class="{
                                    'opacity-50': selectedMemberId !== null &&
                                        selectedMemberId !== '{{ $item['member_id'] }}'
                                }">
                                <td class="p-4 whitespace-nowrap w-px">
                                    <div class="flex items-center">
                                        <label class="inline-flex">
                                            <input class="form-checkbox" type="checkbox" name="selected_loans[]"
                                                :value="{{ $item['loan_id'] }}" :id="'checkbox-' + {{ $item['loan_id'] }}"
                                ...
                                <td class="p-4 whitespace-nowrap">
                                    <div class="text-left font-medium text-slate-800">{{ $item['member_id'] }}</div>
                                </td>
                                <td class="p-4 whitespace-nowrap">
                                    <div class="text-left text-slate-700">{{ $item['item_code'] }}</div>
                                </td>
                                <td class="p-4 whitespace-nowrap">
                                    <div class="text-left text-slate-700">{{ floor($item['keterlambatan']) }} Hari</div>
                                </td>
                                <td class="p-4 whitespace-nowrap">
                                    <div class="text-left text-red-500 font-medium">Rp.
                                        {{ number_format(floor($item['denda']), 0, ',', '.') }}</div>
                                </td>
