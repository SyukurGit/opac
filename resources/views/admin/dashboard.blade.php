                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors duration-150">
                        <td class="py-3.5 px-4 sm:px-6">
                            <span class="text-sm text-slate-600 whitespace-nowrap">10:23 AM</span>
                        </td>
                        <td class="py-3.5 px-4 sm:px-6">
                            <div class="flex items-center space-x-3 min-w-0">
                                ...
                                <span class="text-sm font-medium text-slate-900 truncate">John Doe</span>
                            </div>
                        </td>
                        <td class="py-3.5 px-4 sm:px-6">
                            <span class="text-sm text-slate-700">Meminjam buku "Laravel Advanced"</span>
                        </td>
                        <td class="py-3.5 px-4 sm:px-6">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-emerald-50 text-emerald-700 border border-emerald-200 whitespace-nowrap">
                                Berhasil
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr class="hover:bg-slate-50 transition-colors duration-150">
                        <td class="py-3.5 px-4 sm:px-6">
                            <span class="text-sm text-slate-600 whitespace-nowrap">09:15 AM</span>
                        </td>
                        <td class="py-3.5 px-4 sm:px-6">
                            <div class="flex items-center space-x-3 min-w-0">
                                ...
                                <span class="text-sm font-medium text-slate-900 truncate">Rajul Smith</span>
                            </div>
                        </td>
                        <td class="py-3.5 px-4 sm:px-6">
                            <span class="text-sm text-slate-700">Mengembalikan buku "PHP Basics"</span>
                        </td>
                        <td class="py-3.5 px-4 sm:px-6">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-blue-50 text-blue-700 border border-blue-200 whitespace-nowrap">
                                Selesai
                            </span>
                        </td>
                    </tr>
                    ...
                    <tr class="hover:bg-slate-50 transition-colors duration-150">
                        <td class="py-3.5 px-4 sm:px-6">
                            <span class="text-sm text-slate-600 whitespace-nowrap">08:42 AM</span>
                        </td>
                        <td class="py-3.5 px-4 sm:px-6">
                            <div class="flex items-center space-x-3 min-w-0">
                                ...
                                <span class="text-sm font-medium text-slate-900 truncate">Syukur Johnson</span>
                            </div>
                        </td>
                        <td class="py-3.5 px-4 sm:px-6">
                            <span class="text-sm text-slate-700">Terlambat mengembalikan buku</span>
                        </td>
                        <td class="py-3.5 px-4 sm:px-6">
                            <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-red-50 text-red-700 border border-red-200 whitespace-nowrap">
                                Denda
                            </span>
                        </td>
                    </tr>
